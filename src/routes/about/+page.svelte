...
<svelte:head>
    <title>About Us - Fixonn</title>
</svelte:head>

<section id="aboutUsIntro" class="py-32">
    <div class="font-mukta flex flex-col items-center animate_bottom">
        <h3 class="text-logoIcon font-bold w-fit">ABOUT US</h3>
        <h1 class="mt-4 text-5xl font-semibold text-white">What is Fixonn?</h1>
    </div>
</section>
    ...
    <div class="mx-auto max-w-c-1390 px-6 py-20">
        <div class="flex gap-x-8 font-mukta">
            ...
            <div class="w-1/2 animate_right flex flex-col gap-y-5">
                ...
                <a
                    href="/"
                    class="px-4 py-3 bg-logoIcon text-white rounded-md w-fit"
                    >Send Your Enquiry</a
                >
            </div>
        </div>
...
<section id="vision-and-mission">
    <div class="mx-auto max-w-c-1390 px-6 py-10">
        <div class="flex flex-col gap-y-10 font-mukta px-32">
            <div class="flex gap-x-8">
                <div class="w-1/2 animate_left">
                    <div class="flex flex-col gap-y-5">
                        <h1 class="text-4xl font-bold text-end">Our Mission</h1>
                        <p class="text-lg text-[#757693] text-end">
                ...
                <div class="w-1/2 animate_right">
                    <div class="flex justify-start">
                        <img class="h-96" src="../images/mission.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div class="flex gap-x-8">
                <div class="w-1/2 animate_left">
                    <div class="flex justify-end">
                        <img class="h-96" src="../images/vision.jpg" alt="" />
                    </div>
                </div>
                <div class="w-1/2 animate_right">
                    <div class="flex flex-col gap-y-5">
...
<section id="ourTeam" class="bg-[#FAFAFA]">
    <div class="mx-auto max-w-c-1390 px-6 py-20">
        <div class="font-mukta flex flex-col items-center animate_bottom">
        ...
        <div class="mt-20">
            <div class="flex gap-x-8 justify-center">
                ...
                >
                    <div class="h-80 w-fit overflow-hidden">
                        <img
                            class="h-full"
