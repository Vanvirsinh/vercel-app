...
const css$1 = {
  code: ':root{--swiper-theme-color:#181c31;--swiper-pagination-bullet-inactive-opacity:0.3}.swiper-container.svelte-2etkg3{width:100%;height:550px;position:relative;cursor:w-resize}.swiper-slide.svelte-2etkg3{background-position:center}.item-1.svelte-2etkg3{background-image:linear-gradient(\r\n                rgba(0, 0, 0, 0.386),\r\n                rgba(0, 0, 0, 0.326)\r\n            ),\r\n            url("https://images.unsplash.com/photo-1535191595495-d3222b2eda44?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80")}.item-2.svelte-2etkg3{background-image:linear-gradient(\r\n                rgba(0, 0, 0, 0.386),\r\n                rgba(0, 0, 0, 0.326)\r\n            ),\r\n            url("https://images.unsplash.com/photo-1549057446-9f5c6ac91a04?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1934&q=80")}.item-3.svelte-2etkg3{background-image:linear-gradient(\r\n                rgba(0, 0, 0, 0.386),\r\n                rgba(0, 0, 0, 0.326)\r\n            ),\r\n            url("https://urbango.qodeinteractive.com/wp-content/uploads/2018/09/h1-slide-2.jpg")}',
  map: null
};
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="swiper-container svelte-2etkg3" data-svelte-h="svelte-1ypd89m"><div class="swiper-wrapper"> <div class="swiper-slide item-1 svelte-2etkg3"><div class="h-full w-full bg-[#000]/[0.25]"><div class="h-[90%] mx-auto max-w-c-1390 px-6 flex gap-y-4 justify-center flex-col font-mukta"><h1 class="text-6xl font-bold text-white lg:w-1/2 leading-tight">Heading for the first slide<span class="text-logoIcon">.</span></h1> <p class="text-lg tracking-normal lg:w-1/2 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Dignissimos rem, sint harum modi veniam labore.</p> <a href="#about" class="bg-logoIcon text-white flex px-4 py-3 rounded w-fit">Send Enquiry</a></div></div></div>  <div class="swiper-slide item-2 svelte-2etkg3"><div class="h-full w-full bg-[#000]/[0.25]"><div class="h-[90%] mx-auto max-w-c-1390 px-6 flex gap-y-4 justify-center flex-col font-mukta"><h1 class="text-6xl font-bold text-white lg:w-1/2 leading-tight">Heading for the first slide<span class="text-logoIcon">.</span></h1> <p class="text-lg tracking-normal lg:w-1/2 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Dignissimos rem, sint harum modi veniam labore.</p> <a href="#about" class="bg-logoIcon text-white flex px-4 py-3 rounded w-fit">Send Enquiry</a></div></div></div>  <div class="swiper-slide item-3 svelte-2etkg3"><div class="h-full w-full bg-[#000]/[0.25]"><div class="h-[90%] mx-auto max-w-c-1390 px-6 flex gap-y-4 justify-center flex-col font-mukta"><h1 class="text-6xl font-bold text-white lg:w-1/2 leading-tight">Heading for the first slide<span class="text-logoIcon">.</span></h1> <p class="text-lg tracking-normal lg:w-1/2 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Dignissimos rem, sint harum modi veniam labore.</p> <a href="#about" class="bg-logoIcon text-white flex px-4 py-3 rounded w-fit">Send Enquiry</a></div></div></div></div> <div style="bottom: 70px;" class="swiper-pagination"></div> </div>`;
});
const _page_svelte_svelte_type_style_lang = "";
const css = {
  code: '.service-card.svelte-41nvhv.svelte-41nvhv:hover{transform:scale(105%, 105%)}.service-card.svelte-41nvhv:hover .absolute.svelte-41nvhv{bottom:0}#cta.svelte-41nvhv.svelte-41nvhv{background-image:linear-gradient(\n                to right,\n                rgb(26, 26, 26) 50%,\n                rgba(0, 0, 0, 0)\n            ),\n            url("https://img.freepik.com/free-photo/tiler-working-renovation-apartment_23-2149278561.jpg?w=1060&t=st=1694526270~exp=1694526870~hmac=2884e96890326b2451f0d2efa59f6383eba869d87a05fde94e2b7144c9bb6c48");background-position:100% 100%;background-repeat:no-repeat;background-size:contain}:root{--swiper-theme-color:#181c31;--swiper-pagination-bullet-inactive-opacity:0.3}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1i7s9r_START -->${$$result.title = `<title>Fixonn - A multi-vendor service provider</title>`, ""}<!-- HEAD_svelte-1i7s9r_END -->`, ""}  <section id="hero">${validate_component(Hero, "Hero").$$render($$result, {}, {}, {})}</section>  <div class="animate_bottom relative mx-auto max-w-c-1390 px-6 -translate-y-2/4 z-10"><div class="bg-white flex py-6 px-40 border border-[#e0e0e0] rounded-md">${each$1(icons, (icon) => {
    ...
    return `<div class="text-white font-mukta animate_bottom"><div class="relative ease-in duration-300 rounded-md overflow-hidden service-card cursor-pointer svelte-41nvhv"><img${add_attribute("src", service.img, 0)}${add_attribute("alt", service.title, 0)}> <div class="absolute ease-in duration-300 bottom-[-60px] flex flex-col gap-y-4 p-4 w-full bg-[#000000]/[0.3] svelte-41nvhv"><h3 class="text-xl font-bold">${escape(service.title)}</h3> <a${add_attribute("href", service.url, 0)} class="w-fit bg-logoIcon text-white flex px-4 py-2 rounded">Know More</a> </div></div> </div>`;
                    ...
                    omnis?</p> <a href="/" class="w-fit border-2 border-logoIcon bg-logoIcon text-white flex px-4 py-3 rounded">Send Us an Enquiry</a></div></div></div></section>  <section id="features" class="bg-[#FAFAFA] relative"><div class="mx-auto max-w-c-1390 px-6 py-20"><div class="font-mukta flex flex-col items-center animate_bottom" data-svelte-h="svelte-1l8vgha"><h3 class="text-logoIcon font-bold w-fit">FEATURES</h3> <h1 class="mt-4 text-5xl font-semibold text-black">Why to Choose Fixonn?</h1></div> <div class="flex mt-20 gap-x-8">${each$1(features, (feature) => {
    return `<div class="animate_bottom w-1/3 flex flex-col items-center gap-y-4 p-8 bg-white border border-[#E0E0E0] rounded-md"><h2 class="text-2xl text-black font-semibold">${escape(feature.title)}</h2> <img class="h-16 w-16"${add_attribute("src", feature.img, 0)}${add_attribute("alt", feature.title, 0)}> <p class="text-center text-[#757693] text-md">${escape(feature.description)}</p> </div>`;
  })}</div></div></section>  <section id="enquiryForm" class="bg-white"><div class="mx-auto max-w-c-1390 px-6 py-20"><div><div class="flex gap-x-8 font-mukta"><div class="w-1/2 animate_left" data-svelte-h="svelte-2tw7hr"><div class="font-mukta flex flex-col"><h3 class="text-logoIcon font-bold w-fit">ENQUIRY</h3> <h1 class="mt-4 text-5xl font-semibold text-black">How you can reach out to Fixonn?</h1></div> <div class="mt-10 px-6 flex items-center"><img class="h-[450px]" src="../../images/5127314.jpg" alt=""></div></div> <div class="w-1/2 animate_right"><div class="border-0 border-[#E0E0E0] px-8 rounded-md"><form class="flex flex-col gap-y-4"><div class="flex flex-col gap-y-1" data-svelte-h="svelte-1rhbwr9"><label for="name" class="text-[#757693]">Your Name (Required)</label> <input type="text" id="name" class="border border-[#E0E0E0] rounded-md p-2"></div> <div class="flex flex-col gap-y-1" data-svelte-h="svelte-1jpis14"><label for="email" class="text-[#757693]">Your Email (Optional)</label> <input type="email" id="email" class="border border-[#E0E0E0] rounded-md p-2"></div> <div class="flex flex-col gap-y-1" data-svelte-h="svelte-172fmqq"><label for="phone" class="text-[#757693]">Your Phone (Required)</label> <input type="text" id="phone" class="border border-[#E0E0E0] rounded-md p-2"></div> <div class="flex flex-col gap-y-1"><label for="service" class="text-[#757693]" data-svelte-h="svelte-1pegl1n">Select the Service you want (Required)</label> <select id="service" class="border border-[#E0E0E0] rounded-md p-2"><option value="plumbing" data-svelte-h="svelte-1jbqq5q">Plumbing</option><option value="plumbing" data-svelte-h="svelte-1w7xa9g">Electrical</option><option value="pest control" data-svelte-h="svelte-roksgc">Pest control</option><option value="deep cleaning
                                ...
                                this form!</p></form></div></div></div></div></div></section>  <section id="testimonials" class="bg-[#FAFAFA]"><div class="mx-auto max-w-c-1390 px-6 py-20 overflow-hidden"><div class="font-mukta flex flex-col items-center animate_bottom" data-svelte-h="svelte-153h4q6"><h3 class="text-logoIcon font-bold w-fit">TESTIMONIAL</h3> <h1 class="mt-4 text-5xl font-semibold text-black">What Users say about Fixonn?</h1></div> <div class="testimonial-01 mt-20"><div class="swiper-wrapper animate_bottom">${each$1(reviews, (review) => {
  ...
  })}</div> <div style="position: relative; top: 20px" class="swiper-pagination"></div></div></div></section>  ${validate_component(BackToTop, "BackToTop").$$render($$result, { pathName: "/" }, {}, {})} ${validate_component(ContactIcons, "ContactIcons").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
